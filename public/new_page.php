...
<div id="main">
 <!--  <div id="navigation"> i will work on this navigation separately
  ...
  <div class="container-fluid">
    ...
    <h2>Create Page</h2>
    <form action="new_page.php?subject=<?php echo urlencode($current_subject["id"]); ?>" class="form-group" method="post">
      <p class="lead">Menu name
      ...
      <p class="lead">Content<br />
        <textarea name="content" rows="6" cols="52" class="textarea"></textarea>
      </p>
      <input type="submit" name="submit" value="Create Page" class="btn btn-success btn-block" />
      <a href="manage_content.php?subject=<?php echo urlencode($current_subject["id"]); ?>" class="btn btn-info btn-block">Cancel</a>
    </form>
